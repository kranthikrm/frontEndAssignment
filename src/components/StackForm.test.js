...
describe('StackForm', () => {
  ...
  it('renders the form title', () => {
    expect(stackForm.find('h4').at(1).text()).toEqual('Create A New Information');
  });
  ...
  it('renders a button to add a new info', () => {
    expect(stackForm.find('Button').at(0).props().children).toEqual('Add Info');
  });

  it('renders a button to submit the form', () => {
    expect(stackForm.find('Button').at(1).props().children).toEqual('Save And Add Info');
  });
